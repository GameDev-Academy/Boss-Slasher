...
namespace WeaponsShop
{
    public class OpenButtonPresenter : MonoBehaviour
    {
        ...
        public void Initialize(ScrollButtonsPresenter scrollButtonsPresenter, IWeaponsSettingsProvider weaponsSettingsProvider, IWeaponsService weaponsService, IMoneyService moneyService)
        {
